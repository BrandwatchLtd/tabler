...
/// END MicroEvents
    ...
    **/
    ...
    function validateSpec(spec){
        return _(spec).reduce(function(fields, s, i){
    ...
    **/
    Tabler.create = function(spec, options){
        ...
        _(options.plugins).forEach(function(plugin){
            table.addPlugin(plugin, options[plugin.pluginName]);
        });
    ...
    _.extend(Tabler.prototype, {
        ...
        **/
        destroy: function(){
            ...
            this.spec = [];
            _(this._plugins).forEach(function(pluginName){
        ...
        **/
        formatValue: function(row, colSpec, index){
            ...
            return formatter.call(this, value, colSpec, row, index);
        },
        ...
        **/
        ...
        renderCell: function(row, colSpec, index){
            if(this.cellClassName){
                colSpec.className = ((colSpec.className || '') + ' ' + this.cellClassName).trim();
            }
