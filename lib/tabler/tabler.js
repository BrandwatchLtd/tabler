        ...
        **/
        ...
        renderTable: function(data){
            var spec = this.getSpec(data),
                head, body, foot, standalonePager;
            ...
            standalonePager = this.renderStandalonePaging(data);
            ...
            if(standalonePager && data.showStandalonePager){
                data.$standalonePagerEl.empty().append(standalonePager);
            }
...
///DEBUG*/
        ...
        **/
        ...
        /*
         * Renders pagination as a standalone element usually above the table
         *
         * data: the data being rendered, with data.items [] and totalResults item
        **/
        renderStandalonePaging: function(/*data*/){
            return '';
        },
        /*
