define(['tabler/tabler', 'tabler/tabler.columnGrouper', 'tabler/tabler.aggregator', 'tabler/tabler.toggleColumns', 'tabler/tabler.sortable', 'tabler/tabler.pager', 'tabler/tabler.pageSize'],
        function(tabler, columnGrouper, aggregator, toggleColumns, sortable, pager, pageSize){
    'use strict';
